...
public class MainWindow extends JFrame{
	...
	private DifferencesBetweenTwoSchemataData res;
		...
		fileOpen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if (openDialog.getStatus() != 0) {
					try {
						DifferencesWorker task = 
								new DifferencesWorker(mainPanel,
		...
		fileFOpen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if (openFolderDialog.getStatus() != 0) {
					...
					try {
						DifferencesWorker task = new DifferencesWorker(mainPanel, dir);
						task.execute();
